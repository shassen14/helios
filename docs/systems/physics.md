...
- **`ExternalForce` & `ExternalTorque`:** These are the primary inputs to the physics simulation. Our `Actuation` systems (like `drive_ackermann_cars`) write to these components to make the vehicle move.
