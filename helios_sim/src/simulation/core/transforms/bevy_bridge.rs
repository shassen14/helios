...
use bevy::prelude::{GlobalTransform, Quat as BevyQuat, Transform as BevyTransform, Vec3 as BevyVec3};
...
fn enu_quat_to_bevy_quat(q: &UnitQuaternion<f64>) -> BevyQuat {
    ...
    BevyQuat::from_xyzw(r.coords.x as f32, r.coords.y as f32, r.coords.z as f32, r.coords.w as f32)
}

fn enu_body_quat_to_bevy_quat(q: &UnitQuaternion<f64>) -> BevyQuat {
    let r = Q_ENU_FRAME_TO_BEVY_FRAME.with(|qb| {
        Q_FLU_BODY_TO_BEVY_LOCAL.with(|qf| *qb * q * qf.inverse())
    });
    BevyQuat::from_xyzw(r.coords.x as f32, r.coords.y as f32, r.coords.z as f32, r.coords.w as f32)
}
...
fn bevy_quat_to_enu_quat(q: &BevyQuat) -> UnitQuaternion<f64> {
    ...
    Q_ENU_FRAME_TO_BEVY_FRAME.with(|qb| {
        Q_FLU_BODY_TO_BEVY_LOCAL.with(|qf| qb.inverse() * q64 * *qf)
    })
}
...
mod tests {
    ...
    fn assert_nalgebra_quat_approx_eq(q1: &UnitQuaternion<f64>, q2: &UnitQuaternion<f64>, epsilon: f64) {
        ...
        assert!(
            ...
            q1.coords, q2.coords, angle_diff
        );
    }
    ...
    fn test_enu_body_pose_identity() {
        ...
        assert_bevy_vec3_approx_eq(&bevy.translation, &BevyVec3::ZERO, F32_EPSILON);
        assert_bevy_quat_approx_eq(&bevy.rotation, &BevyQuat::from_rotation_y(-PI_F32 / 2.0), F32_EPSILON);
    }
    ...
    fn test_enu_body_pose_general_and_back() {
        ...
        assert_bevy_vec3_approx_eq(&bevy.translation, &BevyVec3::new(1.0, 0.5, -2.0), F32_EPSILON);
        assert_bevy_quat_approx_eq(&bevy.rotation, &BevyQuat::from_rotation_y(-PI_F32 / 4.0), F32_EPSILON);
