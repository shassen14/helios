// src/simulation/core/abstractions.rs
// use crate::prelude::{AgentConfig, FrameAwareState, StateVariable};
use bevy::prelude::{Component, Entity};
use nalgebra::{DMatrix, DVector};
use std::fmt::Debug;

use crate::simulation::{
    core::frames::{FrameAwareState, StateVariable},
...
// Component to hold the dynamics model on the agent entity.
#[derive(Component)]
...
// Component to hold the measurement model on a sensor child entity.
#[derive(Component)]
